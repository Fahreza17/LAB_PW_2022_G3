...
<body style="background-color:black;">
  ...
  <nav class="navbar navbar-dark bg-secondary fixed-top">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="/pe">Permission</a>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="/c/edit/{{ $category->id }}" type="button" class="btn btn-outline-primary">Edit</a>
                <a href="/c/delete/{{ $category->id }}" type="button" class="btn btn-outline-danger">Delete</a>
              </td>
            </tr>
            @endforeach
