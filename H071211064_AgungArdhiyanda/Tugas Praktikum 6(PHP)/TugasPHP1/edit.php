    ...
    <div class="container">
        <form style="margin-top:15px;" action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="student_name" class="form-control" name="student_name" value="<?php echo $row[0]['student_name']; ?>" required>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Alamat</label>

                <input type="text" id="address" class="form-control" name="address" value="<?php echo $row[0]['address'] ?>">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Fakultas</label>
                <input type="text" id="faculty" class="form-control" name="faculty" value="<?php echo $row[0]['faculty']; ?>">
